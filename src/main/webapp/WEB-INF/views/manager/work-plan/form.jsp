...
<script type="text/javascript">
	...
	function calculateSelectedTasksDates() {
		if(taskSelection.length > 0) {
			...
			var suggestedStartDate = new Date(earliestStartDate);
			suggestedStartDate.setDate(earliestStartDate.getDate()-1);
			...
			if(suggestedStartDate < new Date()){
				suggestedStartDate.setDate(earliestStartDate.getDate());
				suggestedStartDate.setHours(earliestStartDate.getHours());
				suggestedStartDate.setMinutes(earliestStartDate.getMinutes());
			}	
			...
			var suggestedEndDate = new Date(latestEndDate);
